<footer class="footer bg-danger">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 mt-4 col-lg-4 text-center text-sm-start">
                <div class="contact">
                    ...
                    <a href="tel:+" class="text-white mb-1 text-decoration-none d-block fw-semibold"><i class="bi bi-telephone"></i> 039420XXXX</a>
                    <a href="mailto:" class="text-white mb-1 text-decoration-none d-block fw-semibold"><i class="bi bi-envelope"></i> khacvi2003@gmail.com</a>
    ...
    <div class="text-center bg-dark text-white mt-4 p-1">
        <p class="mb-0 fw-bold">2023 © Doan Khac Vi, All Rights Reserved</p>
    </div>
</footer>
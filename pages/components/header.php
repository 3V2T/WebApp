            ...
            <div class="d-flex" style="gap: 16px;">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" style="box-shadow: 2px 2px 5px 2px #cccc;" aria-labelledby="navbarDropdown">
                            <?php echo (isset($_SESSION['is_admin'])) ? '<a class="dropdown-item" href="/WebApp/pages/me.php">Đổi mật khẩu</a>' : '<a class="dropdown-item" href="/WebApp/pages/me.php">Thông tin cá nhân</a>

...
<div class="slider h-75 overflow-hidden position-relative">
    <div class="d-flex container-slide" style="width: 300%; height: 100%; transition: all 0.5s;">
        <div class="slide"
            style="height: 100%; width: calc(100%/3) ;background-image: url(https://www.ctvnews.ca/content/dam/ctvnews/en/images/2024/3/1/library-toronto-1-6790612-1709293812660.jpg); background-position: center; background-size: cover;">
        </div>
        <div class="slide"
